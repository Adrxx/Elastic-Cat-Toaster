...
//#-end-hidden-code
/*:
 Inssssaass this playground, you’ll learn how to draw mathematical shapes called roulettes.
 ...
 Inssbs the cycloid above, the thick, curved line, or **path**, is the actual roulette. The light-blue circle is the moving curve, or **wheel**, that draws the roulette shape. The thin, flat line near the bottom is the fixed curve (in this case, a straight line), or **track**, that the wheel moves on.
